    ...
    <ProductListItemStyled colors={colors}>
      <div className="ProductListItemWrapper">
        ...
        <p className="ProductListItemSale">
          <span className="ProductListItemName">Sale:</span> {isSale ? "Действует акционная цена" : "В акции не участвует"}
        </p>
        ...
        <p className="ProductListItemPrice">
          <span className="ProductListItemName">Price:</span> <span>{price}</span>
        </p>
        <div className="ProductListItemButtonsGroup">
          <button type="button" className="addToCartButton" onClick={addNewProduct}>
            Add to Cart
          </button>
