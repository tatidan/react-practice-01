...
class ProductForm extends Component {
  ...
  onHandleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://shop-49287-default-rtdb.firebaseio.com/products.json", this.state);
  ...
  function 
    ...
    render() {
      ...
      return (
        <>
          <ProductFormStyled onSubmit={this.onHandleSubmit} className="productForm">
            <div className="formWrapper">
              <div className="formColumn">
                ...
                <label>
                  Description
                  <textarea name="description" cols="100" rows="6" value={description} onChange={this.onHandleChange} />
                </label>
              </div>
              ...
              <div className="formColumn">
                <label>
                  Price
                  <input type="number" name="price" value={price} onChange={this.onHandleChange} />
                </label>
